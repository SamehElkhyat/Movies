...
<div className="row mt-4">
 <div className="col-lg-4 col-md-12 mb-4 mb-md-0">
   ...
   <div className="mt-1">
     <Link to='https://www.facebook.com/' type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-facebook-f"></i></Link>
     <Link type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-linkedin"></i></Link>
     <Link type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-instagram"></i></Link>
     <Link type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-google-plus-g"></i></Link>
   </div>
 </div>
